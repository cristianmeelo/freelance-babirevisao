...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  ...
  gtag('config', 'GTM-N4BD7GW8');`,
      ...
      <meta name="google-site-verification" content="1yZPEyTMLckkXs9h_sX0CUyXSO26jNLgZMT2nYKfXB8" />      <body className={`${arimo.variable} font-inter antialiased bg-roxo-500 text-cinza-500 tracking-tight`}>
