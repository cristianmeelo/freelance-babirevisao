      ...
      <div className="h-screen max-w-6xl mx-auto px-4 sm:px-6 ">
        ...
        <div className="pt-32 pb-12 md:pt-40 md:pb-20">
          ...
          <div className="absolute mx-auto px-4 sm:px-6 -z-1 w-1/5 hidden sm:block  ">
            <Lottie animationData={animationData} aria-describedby="Um conjunto de livros de diversas cores e sem desenhos na capa executando uma animação de serem organizados e saírem voando." />
          </div>
          <div className="absolute left-3/4 top-0 -z-1 w-1/5 hidden sm:block opacity-20 ">
            <Lottie
              animationData={animationLetters}
              aria-aria-describedby="Um conjunto de letras na cor azul escuro do alfabeto português com tipografia de serifa caindo em um fluidez de cima para baixo, e a medida que faz a animação, as letras vão obtendo uma transparência até sumir completamente."
            />
          </div>
        </div>
      </div>
