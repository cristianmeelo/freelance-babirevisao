            ...
            <div className="focus:outline-none focus:ring focus:ring-black relative flex items-start border-2 border-gray-200 rounded bg-white" tabIndex={0}>
              ...
              <div className="text-center px-12 py-8 pt-20 mx-4 md:mx-0">
                ...
                <div className="text-gray-600">
                  ...
                  <a className="text-blue-600 hover:underline focus:outline-none focus:ring focus:ring-black" href="https://www.instagram.com/babirevisora/?igshid=OGQ5ZDc2ODk2ZA%3D%3D" target="_blank">
                    @babirevisora
                  </a>
                </div>
              </div>
