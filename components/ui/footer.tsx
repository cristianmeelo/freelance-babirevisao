      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="md:flex md:items-center md:justify-between py-4 md:py-8 border-t border-gray-200">
          ...
          <a className="text-sm text-roxo-400 mr-4 hover:underline focus:outline-none focus:ring focus:ring-black"
           tabIndex={0}
           href="mailto:barbara.babiconsultoria@gmail.com?subject=Orçamento Consultoria de TCC&cc=suporte@babirevisao.com&body=Olá Babi Consultoria, gostaria de saber mais informações sobre a consultoria! Aguardo seu retorno.">
